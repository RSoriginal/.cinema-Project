        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Trailers = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CinemaUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_propositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_propositions_AspNetUsers_CinemaUserId",
                        column: x => x.CinemaUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_propositions_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_propositions_CinemaUserId",
                table: "propositions",
                column: "CinemaUserId");

            migrationBuilder.CreateIndex(
                name: "IX_propositions_MovieId",
                table: "propositions",
                column: "MovieId");
