...
{
    public sealed class PropositionService : IPropositionService
    {
        readonly ApplicationDbContext _context;
        public PropositionService(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<PropositionResponse?> AddPropositionAsync(PropositionAddRequest? addProp)
        {
            ...
            var newProposition = await _context.propositions.AddAsync(new Proposition()
            {
...
/*        public async Task<List<PropositionResponse>> GetAllPropositionsAsync(Guid? UserID)
        ...
        public async Task<PropositionResponse>? GetPropositionAsync(int propositionID)
        {
            ...
            return Proposition.ToPropositionResponse();
        }
